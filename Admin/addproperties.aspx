               ...
               <div class="card-body">
                  ...
                  <div class="form-row">
                     <div class="form-group col-md-4">
                        ...
                        <asp:textbox ID="MinPrice" cssClass="form-control" runat="server"></asp:textbox>
                     </div>
                     <div class="form-group col-md-4">
                        <label for="inputEmail4">Maximum Price</label>
                        <asp:textbox ID="maxPrice" cssClass="form-control" runat="server"></asp:textbox>
                     </div>
                     <div class="form-group col-md-4">
                  ...
                  <div class="form-row">
                    ...
                    <label for="inputEmail4">I have a</label>
                     ...
                     <div class="form-group col-md-3">
                       <label for="inputEmail4">Available For</label>
                  ...
                  <div class="form-group">
                     ...
                     <textarea  class="form-control"  name="googlemap" aria-describedby="emailHelp"></textarea>
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">Short Discription</label>
                     <textarea  class="form-control"  name="shortdis" ></textarea>
                  </div>

                   <div class="form-group">
                     <label for="exampleInputEmail1">Long Discription</label>
                     <textarea  class="form-control" id="editor3" name="longdis" rows="10" aria-describedby="emailHelp"></textarea>
                  </div>


                  <div class="form-group">
                     <label for="exampleInputEmail1">Near By Places</label>
                     <textarea  class="form-control" id="editor2" name="nearby" rows="10" aria-describedby="emailHelp"></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <asp:textbox ID="fulladd" cssClass="form-control" runat="server"></asp:textbox>
                  </div>
                  <asp:button ID="Button1" CssClass="btn btn-success" runat="server" Text="Save And Publish" OnClick="addproperties" />
              </form>
               </div>
            </div>
         </div>
